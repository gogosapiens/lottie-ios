...
//                    addSubview(view)
    ...
    func editableCompositionLayersForTouch(_ touch: UITouch) -> [CompositionLayer] {
        ...
        func addSublayersOfLayer(layer: CALayer) {
            layer.sublayers?.forEach { sublayer in
                if let imageCompositionLayer = sublayer as? ImageCompositionLayer, imageCompositionLayer.isEditable {
                    let rect = imageCompositionLayer.contentsLayer.convert(imageCompositionLayer.contentsLayer.bounds, to: self.layer)
    ...
    /**
     Sets the font provider for animation view. A font provider provides the
     animation with values for text layers
     */
    ...
    public init(animation: Animation?, imageProvider: AnimationImageProvider? = nil, textProvider: AnimationTextProvider = DefaultTextProvider(), fontProvider: AnimationFontProvider = DefaultFontProvider()) {
